        ...
        <div class="sidebar">
            ...
            <div class="nContainer">                
                <ul class="navigation">         
                    ...
                    <li class="active"><a href="<?php echo base_url(); ?>index.php/webadmin/labels" class="blgreen">Label</a></li>               
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>All Label <small>calonpresident.blogspot.com</small></h1>
                </div>
				<!-- start -->
				<div class="row-fluid">
					<div class="block">
					...
					<div class="span6">
                        <div class="block">
                            ...
                            <div class="data-fluid">                                
                                <div class="row-form">
								<form method="post" id="validate" action="<?php echo base_url(); ?>index.php/webadmin/savelabel">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" class="table lcnp">
									...
									<?php foreach($label as $l){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>index.php/webadmin/editlabel/<?php echo $l['kode_label']; ?>" class="button green">
                                                    <div class="icon"><span class="ico-pencil"></span></div>
                                                </a>
                                                <a href="<?php echo base_url(); ?>index.php/webadmin/deletelabel/<?php echo $l['kode_label']; ?>" onclick="return confirm('yakin hapus data ini??');" class="button red">
